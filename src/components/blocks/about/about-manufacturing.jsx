    ...
    <section className="w-full h-auto block py-10 xl:py-[55px_75px] 2xl:py-[65px_85px] 3xl:py-[80px_110px] bg-[#181818] overflow-hidden">
      <div className="container">
        <div className="flex flex-wrap items-center justify-between gap-x-10 lg:gap-x-[65px] 2xl:gap-x-[74px] 3xl:gap-x-[100px]">
          <div className="w-full lg:w-[420px] xl:w-[500px] 2xl:w-[600px] 3xl:w-[760px]">
          ...
          <div className="w-full lg:flex-1">
            <div className="w-full">
              ...
              {data.items?.map((item) => (
                <div
                  key={item.id}
                  className="w-full py-2 xl:py-4.5 2xl:py-5 3xl:py-6"
                >
                  <div className="group w-full flex flex-wrap gap-x-3 lg:gap-x-5 2xl:gap-x-6 3xl:gap-x-8">
