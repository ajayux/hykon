        ...
        <div className="flex flex-wrap items-end justify-between mb-8 xl:mb-10 2xl:mb-12.5 3xl:mb-15">
          ...
          <div className="max-sm:w-full flex flex-wrap gap-6 sm:gap-8 xl:gap-10 2xl:gap-12.5 3xl:gap-15">
            <div>
              ...
              >
                <SelectTrigger className="text-[14px] 2xl:text-[16px] 3xl:text-[20px] leading-none font-normal text-white data-[placeholder]:text-white/80 w-[120px] xl:w-[140px] 2xl:w-[160px] 3xl:w-[190px] p-0 border-0 border-b-2 border-b-[#008dd2] rounded-none hover:scale-100 focus:ring-0 focus:ring-offset-0">
