        ...
        <div className="w-full">
          <div className="flex flex-wrap md:-m-25px xl:-m-50px 2xl:-m-70px 3xl:-m-85px md:[&>*]:p-[25px] xl:[&>*]:p-[50px] 2xl:[&>*]:p-[70px] 3xl:[&>*]:p-[85px]">
            <div className="w-full md:w-[45%]">
              ...
              <div className="w-full  mt-[20px] sm:mt-[25px] xl:mt-[50px] 2xl:mt-[70px] 3xl:mt-[85px]">
                {cultureData.features.map((item, index) => (
                <div key={index} className="w-full">
                  <div className="flex items-center gap-[12px] sm:gap-[15px] 2xl:gap-[18px] 3xl:gap-[20px] mb-[20px] sm:mb-[25px] xl:mb-[40px] 2xl:mb-[52px] 3xl:mb-[65px]"> 
