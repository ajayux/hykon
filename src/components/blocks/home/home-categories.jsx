  ...
  return (
    <section className="w-full h-auto bg-[#171d1f] block py-6 lg:py-8.5 2xl:py-10 3xl:py-12 overflow-hidden">
      ...
      >
        ...
        >
          <div className="flex touch-pan-y touch-pinch-zoom -mx-1 xl:-mx-1.5 3xl:-mx-2 [&>*]:p-1 xl:[&>*]:p-1.5 3xl:[&>*]:p-2">
            {data?.map((item) => (
              <Link
                href={`/category/${item?.slug}`}
                key={item?.id}
                className={cn(
                  "flex-[0_0_130px] lg:flex-[0_0_130px] xl:flex-[0_0_124.5px] 2xl:flex-[0_0_150px] 3xl:flex-[0_0_185px] min-w-0 select-none",
                )}
              >
