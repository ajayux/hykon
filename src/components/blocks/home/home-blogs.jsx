...
export default function HomeBlogs({ data }) {
  ...
  return (
    <section className="w-full h-auto block bg-[#181818] pb-10 xl:pb-[66px] 2xl:pb-20 3xl:pb-[100px] relative z-0">
      <div className="text-[80px] sm:text-[140px] xl:text-[166px] 2xl:text-[200px] 3xl:text-[250px] font-bold leading-none uppercase text-center text-[#181818] select-none opacity-40 absolute -z-1 top-0 inset-x-0 [-webkit-text-stroke:1px_#595959] -translate-y-1/3">
        {parse(data?.title)}
      </div>
      <div
        className={cn(
