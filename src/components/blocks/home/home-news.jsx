...
//       <div className="text-[100px] sm:text-[140px] xl:text-[166px] 2xl:text-[200px] 3xl:text-[250px] font-bold leading-none uppercase text-center text-gray-900 select-none opacity-40 absolute -z-1 top-0 inset-x-0 ">
//         {parse(data?.title)}
//       </div>
...
//               </Text>
//             </div>
//             <FilterItems className="hidden lg:flex" items={data?.filterItems} />
//           </div>
...
//             <FilterItems items={data?.filterItems} />
//           </div>
//         </div>
//       </div>
//       <div
...
//                         <div
//                           className={cn(
//                             "text-[20px] sm:text-[24px] lg:text-[28px] xl:text-[35px] 2xl:text-[42px] 3xl:text-[53px] leading-none font-normal text-center text-white mb-1 xl:mb-2",
//                           )}
//                         >
//                           {item?.publishDay}
//                         </div>
//                         <div
//                           className={cn(
//                             "text-[10px] lg:text-[12px] xl:text-[15px] 2xl:text-[18px] 3xl:text-[22px] leading-none font-normal text-center text-white",
//                           )}
//                         >
...
// function FilterItems({ items, className }) {
//   return (
//     <div
//       className={cn(
...
//             size="lg"
//             variant="none"
//             className={cn("text-white p-0 relative z-0")}
//           >
//             {item}
//             <span
//               className={cn(
...
export default function HomeNews({ data }) {
  ...
  return (
    <section className="w-full h-auto block bg-[#212121] py-8 xl:py-13 2xl:py-15 3xl:py-20 relative z-0">
      <div className="text-[100px] sm:text-[140px] xl:text-[166px] 2xl:text-[200px] 3xl:text-[250px] font-bold leading-none uppercase text-center text-[#212121] select-none opacity-40 absolute -z-1 top-0 inset-x-0 [-webkit-text-stroke:1px_#595959]">
        {parse(data?.title)}
      </div>
      <div className="container">
        <div className="flex flex-wrap sm:items-end gap-4 sm:gap-x-6 xl:gap-x-12 2xl:gap-x-17.5 3xl:gap-x-21.5 mb-8 xl:mb-10 2xl:mb-11 3xl:mb-15">
