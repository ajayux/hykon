      ...
      <div className="container">
        ...
        <div className="flex flex-wrap justify-center gap-3 sm:gap-5 xl:gap-7 2xl:gap-8 3xl:gap-10">
          {data?.items?.map((item) => (
            <div
              key={item?.id}
              className="w-[130px] min-[376px]:w-[160px] sm:w-[268px] xl:w-[270px] 2xl:w-[325px] 3xl:w-[410px]"
            >
              <div className="group w-full h-full bg-[#171f23] rounded-[8px] 2xl:rounded-[10px] 3xl:rounded-[12px] px-3 xl:px-5 2xl:px-6.5 3xl:px-8 py-5 xl:py-7 2xl:py-8 3xl:py-10 flex flex-wrap items-center gap-3 sm:gap-x-5 lg:gap-x-7 2xl:gap-x-8.5 3xl:gap-x-10">
