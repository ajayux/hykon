              ...
              {data?.productInfo?.productItems?.length > 0 ? (
                <>
                  {data?.productInfo?.productItems?.map((item) => (
                    ...
                    >
                      <div className="group w-full h-auto px-4 xl:px-8 3xl:px-10 py-4 xl:py-6 3xl:py-7.5 bg-[#212121] rounded-[8px] 2xl:rounded-[9px] 3xl:rounded-[11px] transition-all duration-500">
