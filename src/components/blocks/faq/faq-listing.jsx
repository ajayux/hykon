        ...
        {items?.map((item) => {
          ...
          return (
            <Button
              ...
              variant="none"
              className={cn(
                "text-[10px] sm:text-[12px]  xl:text-[14px] 2xl:text-[18px] 3xl:text-[22px] capitalize text-white p-0 relative z-0 transition-colors",
                isActive ? "text-white" : "hover:text-[#008dd2]",
              )}
            >
              <span className="px-2 xl:px-4 2xl:px-5.5 3xl:px-7 pb-1 xl:pb-2 2xl:pb-3 3xl:pb-4 block">{item?.title}</span>
              <span
                className={cn(
