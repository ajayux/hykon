...
const landingData = {
  ...
  landingPerformance: {
    ...
    specifications_list: [
      { id: 1, label: "Battery Type", value: "LiFePO4" },
      { id: 2, label: "Nominal Voltage", value: "25.6 V" },
      { id: 3, label: "Capacity", value: "100 Ah" },
      { id: 4, label: "Charging Voltage", value: "28.8 V" },
      { id: 5, label: "Standard Charging Current", value: "50 A (0.5C)" },
      { id: 6, label: "Max Discharge Current", value: "100 A" },
      { id: 7, label: "Dimensions (L×W×H)", value: "370 × 150 × 360 mm" },
      { id: 8, label: "Weight", value: "Approx. 24 kg" },
      { id: 9, label: "Compatibility", value: "All inverter & solar systems" },
      { id: 10, label: "Warranty", value: "5 Years" },
    ],
  },
  landingTrusted: {
    ...
    trusted_list: [
      {
        ...
        name: "Homeowner",
        location: "Kerala",
        media: { path: "/images/trusted-1.jpg", alt: "trusted-1" },
      },
      {
        id: 2,
        description:
        ...
        location: "Kerala",
        media: { path: "/images/trusted-2.jpg", alt: "trusted-1" },
      },
      {
        id: 3,
        description:
        ...
        location: "Kerala",
        media: { path: "/images/trusted-3.jpg", alt: "trusted-1" },
      },
      {
        id: 4,
        description:
  ...
  landingFooter: {
    ...
    locations: [
      { id: 1, email: "info@company.com", title: "Thrissur", isExternal: true },
      { id: 2, email: "info@company.com", title: "Coimbatore", isExternal: true },
      { id: 3, email: "info@company.com", title: "Kochi", isExternal: true },
      { id: 4, email: "info@company.com", title: "Pune", isExternal: true },
    ],
    copyright: "© 2026 HYKON. All rights reserved.",
    socialLinkData: [
      { link: "/", icon: "/images/facebook.svg", name: "Facebook" },
      { link: "/", icon: "/images/youtube.svg", name: "youtube" },
      { link: "/", icon: "/images/instagram.svg", name: "instagram" },
      { link: "/", icon: "/images/linkedin.svg", name: "linkedin" },
      { link: "/", icon: "/images/x.svg", name: "x" },
    ],
  },
};
