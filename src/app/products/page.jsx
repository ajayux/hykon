    ...
    "items": [
      {
        ...
        "description": "<p>The best and ideal domestic solar water heater for all your hot water requirements at home with amazing features such as:</p><ul><li>Multi-stage Liquid Injection Puff filling</li><li>On-Site Warranty</li><li>Safe Water for Cooking Purpose</li><li>High Thermal Efficiency</li><li>Evacuated Tube with 3 Layers</li><li>Reliable Welding Technology</li><li>Rust Proof</li></ul>",
        "slug": "jupiter-series",
        "media": {
          "type": "image",
        ...
        "variants": {
          "title": "Available options <a href=\"#\"> (Jupiter)</a>",
          "items": [
            {
              "id": 1,
              "title": "Jupiter 130",
